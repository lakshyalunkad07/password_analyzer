...
- [wordlist.txt](./wordlist.txt) - external dictionary wordlist used by the dictionary attack
...
- The dictionary attack now loads passwords from `wordlist.txt`, with a fallback list inside `script.js` if the file cannot be loaded.
